...
class CreateCursosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('docente_id')->unsigned()->nullable()->default(null);

            $table->index(["docente_id"], 'fk_cursos_users1_idx');


            $table->foreign('docente_id', 'fk_cursos_users1_idx')
